...
function JoinOurTeamForm({
  ...
  const onSubmit = (data: JoinOurTeamForm) => {
    ...
    setTimeout(() => {
      ...
      // After processing, reset the button status to false
  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed right-0 left-0 bottom-0 top-[80px] items-center justify-center p-4 overflow-y-auto h-auto">
